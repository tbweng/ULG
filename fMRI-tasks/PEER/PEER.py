...
expName = 'PEER'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/utbrainstudy/ULG/fMRI-tasks/PEER/PEER.py',
...
win = visual.Window(
    ...
    monitor='scanner', color=[-1,-1,-1], colorSpace='rgb',
...
text = visual.TextStim(win=win, name='text',
    text='Stay focused on the\nwhite fixation circle',
    font='Arial',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('dot_coordinates_scanner_display.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if t >= 0.0 and dot.status == NOT_STARTED:
            # keep track of start time/frame for later
            dot.tStart = t  # not accounting for scr refresh
